...
BEGIN
  ...
  IF v_account_id IS NULL THEN
    ...
    IF v_request.requested_password_hash IS NOT NULL THEN
      -- Use the pre-hashed password from registration
      INSERT INTO resident_accounts (resident_id, username, password_hash, account_status)
      VALUES (v_resident_id, v_username, v_request.requested_password_hash, 'Active')
      RETURNING id INTO v_account_id;
